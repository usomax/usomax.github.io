...
(function($) {
  ...
  function circle() {
    ...
    scrollEvent = function() {
      ...
      var itemSizeDiff = $itemSize * 1.1; // 要素の差分
      ...
      for (var i = 0; i < $itemList; i++) {
        ...
        /* 座標を動かす要素 */
        $stageItemL.eq(i).css({ "-webkit-transform":"translate3d("+leftX+"px,"+leftY+"px,0)" });
        $stageItemR.eq(i).css({ "-webkit-transform":"translate3d("+rightX+"px,"+rightY+"px,0)" });
        /* 回転させる */
        angle += increase;
      }
    }
